...
function Ue(t, e, n) {
  const o = E.useRef(null), r = E.useCallback(
    ...
    [t, e]
  ), { callbackRef: s, ref: i } = $e(r, !0, n), l = E.useCallback(() => {
    r(i.current);
  }, [r, i]);
  return E.useEffect(() => {
    if (e) {
...
const Xn = j(
  ...
  rt(Gt),
  { singleton: !0 }
), Ko = typeof document < "u" && "scrollBehavior" in document.documentElement.style;
function Jn(t) {
      ...
      x(
        ...
        B(
          ([
            ...
            return f = setTimeout(() => {
              S();
            }, 1200), M(c, !0), O("scrolling from index to", { behavior: q, index: lt, top: St }, ft.DEBUG), { behavior: q, top: St };
          }
        )
      ),
      d
...
const ue = "up", ne = "down", qo = "none", Yo = {
  atBottom: !1,
  ...
  const i = T(!1), l = T(!0), c = U(), d = U(), m = T(4), v = T(Zo), p = ht(
    x(
      Fe(x(W(r), Ut(1), Bt(!0)), x(W(r), Ut(1), Bt(!1), hn(100))),
      nt()
    ),
    !1
  ), I = ht(
    x(Fe(x(n, Bt(!0)), x(n, Bt(!1), hn(200))), nt()),
    !1
  );
  z(
    x(
...
const Kt = j(
  ...
  viewportBottom: s,
  viewportTop: i
}) => e < i ? { ...r, align: n ?? "start", ...o === void 0 ? {} : { behavior: o } } : t > s ? { ...r, align: n ?? "end", ...o === void 0 ? {} : { behavior: o } } : null, oo = j(
  ([
...
const tr = (t, e) => typeof t == "function" ? Rn(t(e)) : e && Rn(t), er = j(
  ([
    ...
    Y(
      x(
        ...
        B(([[y, L], u, g, C, k]) => {
          let O = L && C, V = "auto";
          return O && (V = tr(u, g || k), O = O && V !== !1), { followOutputBehavior: V, shouldFollow: O, totalCount: y };
        }),
        P(({ shouldFollow: y }) => y)
      ),
    ...
    return z(
      ...
      x(
        at(x(H, Ut(1)), c),
        $(W(S), l, v, p),
        B(([[y, L], u, g, C, k]) => L && g && u?.({ context: k, totalCount: y, scrollingInProgress: C })),
        P((y) => !!y),
        zt(0)
      ),
      (y) => {
...
const lr = so(() => /iP(ad|od|hone)/i.test(navigator.userAgent) && /WebKit/i.test(navigator.userAgent)), cr = j(
  ([
...
function Je(t, e, n) {
  ...
  const v = E.forwardRef(function(a, S) {
    const { children: H, ...y } = a, [L] = E.useState(() => ye(Eo(t), (C) => {
      c(C, y);
    })), [u] = E.useState(pn(m, L));
    Ie(() => {
      for (const C of i)
      ...
      c(L, y);
    }), E.useImperativeHandle(S, mn(d(L)));
    const g = n;
    return /* @__PURE__ */ G(l.Provider, { value: L, children: n === void 0 ? H : /* @__PURE__ */ G(g, { ...ar([...o, ...r, ...i], y), children: H }) });
  }), p = (f) => {
    ...
    const S = E.useContext(l)[f], [H, y] = E.useState(pn(it, S));
    return Ie(
      () => Y(S, (L) => {
        L !== H && y(mn(L));
      }),
...
const Re = E.createContext(void 0), lo = E.createContext(void 0), Le = "-webkit-sticky", Hn = "sticky", Qe = so(() => {
  if (typeof document > "u")
    return Hn;
  const t = document.createElement("div");
  return t.style.position = Le, t.style.position === Le ? Le : Hn;
}), co = typeof document > "u" ? E.useEffect : E.useLayoutEffect;
function ke(t) {
  return "self" in t;
}
function dr(t) {
...
function uo(t, e, n, o = Jt, r, s) {
  const i = E.useRef(null), l = E.useRef(null), c = E.useRef(null), d = E.useCallback(
    (p) => {
      ...
      p.suppressFlushSync === !0 ? f() : xo.flushSync(f), l.current !== null && (R === l.current || R <= 0 || R === I - w) && (l.current = null, e(!0), c.current && (clearTimeout(c.current), c.current = null));
    },
    [t, e, s]
  );
  E.useEffect(() => {
    const p = r ?? i.current;
    return gn(p), o(r ?? i.current), d({ suppressFlushSync: !0, target: p }), p.addEventListener("scroll", d, { passive: !0 }), () => {
...
const fr = /* @__PURE__ */ j(() => {
  ...
  ([t, e]) => ({ ...t, ...e }),
  rt(io, fr)
), pr = ({ height: t }) => /* @__PURE__ */ G("div", { style: { height: t } }), hr = { overflowAnchor: "none", position: Qe(), zIndex: 1 }, ao = { overflowAnchor: "none" }, gr = { ...ao, display: "inline-block", height: "100%" }, En = /* @__PURE__ */ E.memo(function({ showTopList: e = !1 }) {
...
const vr = /* @__PURE__ */ E.memo(function() {
...
function nn({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return E.memo(function({ children: s, style: i, context: l, ...c }) {
    const d = n("scrollContainerState"), m = e("ScrollerComponent"), v = n("smoothScrollTargetReached"), p = e("scrollerRef"), I = e("horizontalDirection") || !1, { scrollByCallback: w, scrollerRef: R, scrollToCallback: h } = uo(
      d,
      v,
      m,
      p,
...
function on({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return E.memo(function({ children: s, style: i, context: l, ...c }) {
    const d = n("windowScrollContainerState"), m = e("ScrollerComponent"), v = n("smoothScrollTargetReached"), p = e("totalListHeight"), I = e("deviation"), w = e("customScrollParent"), R = E.useRef(null), h = e("scrollerRef"), { scrollByCallback: f, scrollerRef: a, scrollToCallback: S } = uo(
      d,
      v,
      m,
      h,
...
const Cr = ({ children: t }) => {
  ...
  const e = E.useContext(Re), n = Ct("windowViewportRect"), o = Ct("fixedItemHeight"), r = A("customScrollParent"), s = A("useWindowScroll"), i = A("topListHeight"), l = Ue(
    n,
    r,
    A("skipAnimationFrameInResizeObserver")
  ), c = A("alignToBottom");
  ...
  }, [e, n, o]), /* @__PURE__ */ G("div", { "data-viewport-type": "window", ref: l, style: en(c, s, i), children: t });
}, yr = ({ children: t }) => {
...
}, br = /* @__PURE__ */ E.memo(function(e) {
  const n = A("useWindowScroll"), o = A("topItemsIndexes").length > 0, r = A("customScrollParent"), s = A("context");
  return /* @__PURE__ */ $t(r || n ? Hr : Rr, { ...e, context: s, children: [
    o && /* @__PURE__ */ G(yr, { children: /* @__PURE__ */ G(En, { showTopList: !0 }) }),
    /* @__PURE__ */ $t(r || n ? wr : Cr, { children: [
      /* @__PURE__ */ G(vr, {}),
      /* @__PURE__ */ G(En, {}),
      /* @__PURE__ */ G(Tr, {})
    ] })
  ...
  br
), Rr = /* @__PURE__ */ nn({ useEmitter: rn, useEmitterValue: A, usePublisher: Ct }), Hr = /* @__PURE__ */ on({ useEmitter: rn, useEmitterValue: A, usePublisher: Ct }), rs = mo, ss = mo, Er = /* @__PURE__ */ j(() => {
  ...
  ([t, e]) => ({ ...t, ...e }),
  rt(io, Er)
), Or = ({ height: t }) => /* @__PURE__ */ G("tr", { children: /* @__PURE__ */ G("td", { style: { height: t } }) }), Lr = ({ height: t }) => /* @__PURE__ */ G("tr", { children: /* @__PURE__ */ G("td", { style: { border: 0, height: t, padding: 0 } }) }), kr = { overflowAnchor: "none" }, Bn = { position: Qe(), zIndex: 2, overflowAnchor: "none" }, On = /* @__PURE__ */ E.memo(function({ showTopList: e = !1 }) {
  ...
  const L = (n ? e.topItems : []).reduce((O, V) => O + V.size, 0), u = e.offsetTop + S + w - L, g = e.offsetBottom, C = u > 0 ? /* @__PURE__ */ G(f, { context: y, height: u }, "padding-top") : null, k = g > 0 ? /* @__PURE__ */ G(f, { context: y, height: g }, "padding-bottom") : null;
  return /* @__PURE__ */ $t(a, { "data-testid": "virtuoso-item-list", ref: p, ...ot(a, y), children: [
    C,
    n && /* @__PURE__ */ G(On, { showTopList: !0 }),
    /* @__PURE__ */ G(On, {}),
    k
  ] });
}), Fr = ({ children: t }) => {
  const e = E.useContext(Re), n = bt("viewportHeight"), o = bt("fixedItemHeight"), r = Lt(
  ...
  const e = E.useContext(Re), n = bt("windowViewportRect"), o = bt("fixedItemHeight"), r = _("customScrollParent"), s = _("useWindowScroll"), i = Ue(
    n,
    r,
    _("skipAnimationFrameInResizeObserver")
  );
  return E.useEffect(() => {
    e && (o(e.itemHeight), n({ listHeight: 0, offsetTop: 0, visibleHeight: e.viewportHeight, visibleWidth: 100 }));
  }, [e, n, o]), /* @__PURE__ */ G("div", { "data-viewport-type": "window", ref: i, style: en(!1, s), children: t });
  ...
  const n = _("useWindowScroll"), o = _("customScrollParent"), r = bt("fixedHeaderHeight"), s = bt("fixedFooterHeight"), i = _("fixedHeaderContent"), l = _("fixedFooterContent"), c = _("context"), d = Lt(
    ...
    !0,
    _("skipAnimationFrameInResizeObserver")
  ), v = o || n ? Gr : Pr, p = o || n ? Vr : Fr, I = _("TableComponent"), w = _("TableHeadComponent"), R = _("TableFooterComponent"), h = i ? /* @__PURE__ */ G(
    w,
    {
      ref: d,
  ...
  Wr
), Pr = /* @__PURE__ */ nn({ useEmitter: sn, useEmitterValue: _, usePublisher: bt }), Gr = /* @__PURE__ */ on({ useEmitter: sn, useEmitterValue: _, usePublisher: bt }), is = po, ls = po, Ln = {
  bottom: 0,
  itemHeight: 0,
  items: [],
  itemWidth: 0,
...
const Nr = /* @__PURE__ */ j(
  ([
    ...
    const L = T(0), u = T(0), g = T(Ln), C = T({ height: 0, width: 0 }), k = T({ height: 0, width: 0 }), O = U(), V = U(), N = T(0), Z = T(null), F = T({ column: 0, row: 0 }), mt = U(), q = U(), Q = T(!1), gt = T(0), lt = T(!0), St = T(!1), Ft = T(!1);
    Y(
      x(
        w,
        $(gt),
...
const Dr = /* @__PURE__ */ j(() => {
  ...
  const e = E.useContext(lo), n = wt("itemDimensions"), o = wt("viewportDimensions"), r = Lt(
    E.useMemo(
      () => (s) => {
  ...
  const e = E.useContext(lo), n = wt("windowViewportRect"), o = wt("itemDimensions"), r = et("customScrollParent"), s = et("useWindowScroll"), i = Ue(n, r, !1);
  return E.useEffect(() => {
  ...
  }, [e, n, o]), /* @__PURE__ */ G("div", { ref: i, style: en(!1, s), children: t });
  ...
  Zr
), Jr = /* @__PURE__ */ nn({ useEmitter: go, useEmitterValue: et, usePublisher: wt }), Qr = /* @__PURE__ */ on({ useEmitter: go, useEmitterValue: et, usePublisher: wt });
function Wn(t, e, n) {
  return e !== "normal" && e?.endsWith("px") !== !0 && n(`${t} was not resolved to pixel value correctly`, e, ft.WARN), e === "normal" ? 0 : parseInt(e ?? "0", 10);
}
const cs = Xr;
