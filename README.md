...
<p align="center">
  <img src="1.2.0/icon.png" alt="AstrWeChat" width="128" height="128">
</p>
...
| 版本 | 文件 | 使用方式 |
| --- | --- | --- |
| Windows 安装版 | `AstrWeChat-1.2.0-Setup.exe` | 运行安装程序，根据提示完成安装 |
...
这些资产提炼自 `1.2.0/src/slim/` 的当前实现，保留布局、颜色、间距、圆角、阴影、交互和响应式规则，但不复制 AstrWeChat 的业务逻辑与品牌文案。
