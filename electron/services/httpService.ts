...
class HttpService {
  ...
  broadcastMessagePush(payload: object): void {
  ...
  private getMessagePushEventName(payload: object): string {
    const eventName = String((payload as { event?: unknown })?.event || '').trim()
