...
export interface ElectronAPI {
  ...
  bridge: {
    ...
    stop: () => Promise<{ success: boolean }>
    status: () => Promise<{ running: boolean; paused: boolean; ob_connected: boolean; weflow_url?: string; ob_url?: string; processRunning: boolean }>
    getLogs: () => Promise<string[]>
    clearLogs: () => Promise<{ success: boolean }>
    getConfig: () => Promise<{ success: boolean; config?: Record<string, unknown>; error?: string }>
    saveConfig: (cfg: Record<string, unknown>) => Promise<{ success: boolean; error?: string }>
