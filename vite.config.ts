...
const handleElectronOnStart = () => {
  // Electron is launched by scripts/dev.cjs only after every main/worker/preload
  // bundle has reached a stable state. Starting it directly from this callback
  // can make the native WCDB runtime fail with -1006 during the initial build.
}
